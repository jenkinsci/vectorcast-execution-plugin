 ...
 * {@code VectorCASTUtils} global in Pipeline scripts.
 *
 ...
 * <pre>{@code
 * def (found, fail, unstable) = VectorCASTUtils.fixupName(VC.mpName)
 * }</pre>
 *
 * <p>The behavior of {@code VectorCASTUtils} is implemented
 * by {@link VectorCASTUtilsBridge}, which loads
...
public class VectorCASTUtilsGlobal extends GlobalVariable {
     ...
     * the {@code VectorCASTUtils} global.
     *
