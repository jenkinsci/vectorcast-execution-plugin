 ...
 * {@code VectorCASTMetrics} global in Pipeline scripts.
 *
 ...
 * VectorCASTMetrics.getMetricsCmds(VC, List<?>)
 * }</pre>
 *
 * <p>The behavior of {@code VectorCASTMetrics} is implemented
 * by {@link VectorCASTMetricsBridge}, which loads
 * a Groovy implementation from the workspace (if present) or
 * falls back to a plugin-bundled default.</p>
 */
@Extension
public class VectorCASTMetricsGlobal extends GlobalVariable {
